            ...
            if(typf.get(i*4)!=null && typf.get((i*4)+3)!=null){
                ...
                for(int k=i+1;k<typf.size()/4;k++){
                    if(listel.get(0)!=null && listel.get(1)!=null && listel.get(0).compareTo(typf.get(k*4))==0 && listel.get(1).compareTo(typf.get((k*4)+3))==0 ){
                        System.out.println("Erreur ligne " + line + " : plusieurs arguments ont le même nom " + listel.get(1)+ " et le même type "+ listel.get(0));
                        TDS.write("Erreur ligne " + line + " : plusieurs arguments ont le même nom " + listel.get(1)+ " et le même type "+ listel.get(0));
                    }
                }
            }
        }
